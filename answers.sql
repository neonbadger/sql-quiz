...
select first_name, last_name, email from salespeople WHERE
region='Northwest';
...
SELECT common_name, price FROM melons WHERE
melon_type='Watermelon' AND price > 5;
